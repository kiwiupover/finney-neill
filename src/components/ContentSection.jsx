...
export function ContentSection({ pageContent }) {
  const image =
    pageContent?.images?.length > 0
      ? pageContent.images[0].secure_url
      : SmilingBaby
      ...
      <div className="grid max-w-2xl grid-cols-1 mx-auto gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <h1 className="mt-2 text-3xl font-bold leading-8 tracking-tight text-gray-900 font-display sm:text-4xl">
                {pageContent.title}
              </h1>
              <p
                className="mt-6 text-xl font-medium leading-8 prose prose-xl text-amber-800"
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="prose lg:pr-4">
            <div
              className="max-w-xl leading-7 prose prose-lg prose-amber prose-h2:text-amber-700 prose-h3:text-amber-700 lg:max-w-lg"
